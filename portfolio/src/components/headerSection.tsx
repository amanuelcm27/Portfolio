    ...
    return (
        <div id="home" className="header flex flex-col justify-center min-w-full h-screen hid">
            <div className="flex h-full bg-pic sm:bg-none sm:h-9/10 sm:m-9">
                <div className={`header-txt flex flex-col uppercase bg-black ${!mode && 'text-white sm:text-inherit'} bg-opacity-70 sm:bg-inherit sm:bg- justify-center p-10 font-extrabold text-4xl w-full sm:w-1/2 md:text-6xl lg:text-6xl 2xl:text-9xl`}>
                    <span>Hi, I am</span>
