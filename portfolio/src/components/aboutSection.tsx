        ...
        <div id="about" className="flex sm:flex-col justify-center min-w-full h-screen hid">
            <div className="flex h-fit sm:h-9/10 m-9">
                ...
                <div className="hidden sm:flex flex-col justify-center items-center w-1/2">
                    <img
                        className={`2xl:w-4k 2xl:h-4k md:w-60 md:h-60 lg:w-96 lg:h-96 shadow-sm hover:shadow-custom-lg rounded-full object-cover hover:scale-110 transition-all duration-500 ${slideIn ? 'slide-in' : 'slide-out'}`}
                        src={img}
                        alt="Profile"
                    />
                </div>
